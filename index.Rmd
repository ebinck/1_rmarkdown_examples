...
The [Poudre River] (https://www.rivers.gov/rivers/cache-la-poudre.php) runs from the Continental Divide to the east, down into the city of [Fort Collins] (https://www.visitftcollins.com/).  In the city, it flows year round.  It is a popular area for recreation, such as [rafting] (https://www.coloradorafting.net/river-trips/poudre-river/), kayaking, fishing, tubing, and more.  The river is dominated by snow melt, and therefore has a **strong peak** in the *spring or early summer* and relatively **low flows** in the *winter*.  
